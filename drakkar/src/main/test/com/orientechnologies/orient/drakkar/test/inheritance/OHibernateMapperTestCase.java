...
public class OHibernateMapperTestCase {
  ...
  public void test1() {
    ...
    try {
      ...
      this.mapper = new OHibernate2GraphMapper("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", OHibernateMapperTestCase.XML_MAPPING_FILE1);
      ...
      assertNotNull(regularEmployeeVertexType.getPropertyByName("id"));
      assertEquals("id", regularEmployeeVertexType.getPropertyByName("id").getName());
      assertEquals("VARCHAR", regularEmployeeVertexType.getPropertyByName("id").getPropertyType());
      assertEquals(1, regularEmployeeVertexType.getPropertyByName("id").getOrdinalPosition());
      assertEquals(true, regularEmployeeVertexType.getPropertyByName("id").isFromPrimaryKey());
      ...
      assertNotNull(contractEmployeeVertexType.getPropertyByName("id"));
      assertEquals("id", contractEmployeeVertexType.getPropertyByName("id").getName());
      assertEquals("VARCHAR", contractEmployeeVertexType.getPropertyByName("id").getPropertyType());
      assertEquals(1, contractEmployeeVertexType.getPropertyByName("id").getOrdinalPosition());
      assertEquals(true, contractEmployeeVertexType.getPropertyByName("id").isFromPrimaryKey());
  ...
  public void test2() {
    ...
    try {
      ...
      this.mapper = new OHibernate2GraphMapper("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", OHibernateMapperTestCase.XML_MAPPING_FILE2);
      mapper.buildSourceSchema(this.context);
      mapper.buildGraphModel(new OJavaConventionNameResolver(), context);
