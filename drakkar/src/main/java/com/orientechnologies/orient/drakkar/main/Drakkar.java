...
public class Drakkar {
   ...
   * @param uri an absolute URI giving the location of the source DB to import
   ...
   * @param outDbUri an absolute URI for the destination Orient Graph DB
   * @param nameResolver the name of the resolver which transforms the names of the elements of the source DB
   *                     according to a specific convention (if null Java convention is adopted)
   */


  public static void execute(String driver, String uri, String username, String password, String chosenStrategy, String outDbUri, String nameResolver) {
    ...
    strategy.executeStrategy(driver, uri, username, password, outDbUri, nameResolver);
