...
package com.orientechnologies.orient.teleport.test;
...
public class OSequentialExecutionsTestCase {
  ...
  public void contentModificationTest2() {
    ...
    try {
      ...
      this.naiveAggregationImportStrategy.executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "basicDBMapper",  null, "java", context);
