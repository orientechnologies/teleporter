...
public class GetVertices {
  ...
  public void test() {
    ...
    /*  CASE 1
     *  GetVertices call without indexes, query on one key and one value
     */
    ...
    /*  CASE 2
     *  GetVertices call with index built on a single property, query on one key and one value
     */
    ...
    /*  CASE 3
     *  GetVertices call with index built on two properties (composite key), query on two key and two values in order to test "composite key behaviour"
     */
