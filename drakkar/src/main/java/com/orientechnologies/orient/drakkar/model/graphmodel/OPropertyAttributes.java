...
public class OPropertyAttributes {
  ...
  public OPropertyAttributes(int ordinalPosition, String attributeType, boolean fromPrimaryKey) {
  ...
  public boolean equals(Object obj) {
   OPropertyAttributes that = (OPropertyAttributes) obj;
