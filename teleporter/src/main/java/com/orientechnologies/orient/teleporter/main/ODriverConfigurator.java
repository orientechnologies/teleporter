...
public class ODriverConfigurator {
  ...
  public static String checkConfiguration(final String driverName, OTeleporterContext context) {
    ...
    try {
      ...
      boolean driverPresent = isDriverAlreadyPresent(driverName, classPath);
   ...
   * @return
   */
  private static boolean isDriverAlreadyPresent(final String driverName, String classPath) {
