...
public class OHibernate2GraphMapper extends OER2GraphMapper {
  ...
  private void detectInheritanceAndUpdateSchema(OEntity parentEntity, Element parentEntityElement, OTeleportContext context) {
  ...
  // Table per Class Hierarchy or Table per Subclass Inheritance
  private void performSubclassTagInheritance(OHierarchicalBag hierarchicalBag, OEntity parentEntity, NodeList subclassElements, Element discriminatorElement, String rootDiscriminatorValue, OTeleportContext context) {
  ...
  // Table per Subclass Inheritance
  private void performJoinedSubclassTagInheritance(OHierarchicalBag hierarchicalBag, OEntity parentEntity, NodeList joinedSubclassElements, OTeleportContext context) {
  ...
  void performUnionSubclassTagInheritance(OHierarchicalBag hierarchicalBag, OEntity parentEntity, NodeList unionSubclassElements, OTeleportContext context) {
