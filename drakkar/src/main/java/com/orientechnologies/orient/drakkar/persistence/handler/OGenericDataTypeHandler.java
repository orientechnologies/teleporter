...
public class OGenericDataTypeHandler implements ODriverDataTypeHandler {
  ...
  public OType resolveType(String type) {
    ...
    // Undefined Types
      ...
      OLogManager.instance().warn(this, "The original type '%s' is not convertible into any Orient type thus, in order to prevent data loss, it will be converted to the Orient Type String.", type);
      return OType.STRING;
    }
