...
1. Move orientdb-oteleporter-1.0.1-SNAPSHOT.jar contained in plugin/ folder to the $ORIENTDB_HOME/plugins folder.
3. Move scripts oteleporter.sh and oteleporter.bat (for Windows users) contained in scripts/ folder to the $ORIENTDB_HOME/bin folder.

Teleporter is ready, you have just to run the tool through the script as described in the documentation (https://github.com/orientechnologies/orientdb-labs/blob/master/Teleporter-Index.md).
