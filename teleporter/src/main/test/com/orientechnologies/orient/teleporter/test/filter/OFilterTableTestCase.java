...
package com.orientechnologies.orient.teleporter.test.filter;
...
public class OFilterTableTestCase {
  ...
  public void test3() {
    ...
    try {
      ...
      this.mapper = new OHibernate2GraphMapper("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", OFilterTableTestCase.XML_TABLE_PER_CLASS, includedTables, null);
      mapper.buildSourceSchema(this.context);
      mapper.buildGraphModel(new OJavaConventionNameResolver(), context);
  ...
  public void test4() {
    ...
    try {
      ...
      this.mapper = new OHibernate2GraphMapper("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", OFilterTableTestCase.XML_TABLE_PER_SUBCLASS1, includedTables, null);
      mapper.buildSourceSchema(this.context);
      mapper.buildGraphModel(new OJavaConventionNameResolver(), context);
  ...
  public void test5() {
    ...
    try {
      ...
      this.mapper = new OHibernate2GraphMapper("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", OFilterTableTestCase.XML_TABLE_PER_SUBCLASS2, null, excludedTables);
      mapper.buildSourceSchema(this.context);
      mapper.buildGraphModel(new OJavaConventionNameResolver(), context);
  ...
  public void test6() {
    ...
    try {
      ...
      this.mapper = new OHibernate2GraphMapper("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", OFilterTableTestCase.XML_TABLE_PER_CONCRETE_CLASS, includedTables, null);
      mapper.buildSourceSchema(this.context);
      mapper.buildGraphModel(new OJavaConventionNameResolver(), context);
