...
call %JAVA% -server %ORIENTDB_SETTINGS% -Dfile.encoding=utf-8 -Dorientdb.build.number="@BUILD@" -cp "%ORIENTDB_HOME%\lib\*;%ORIENTDB_HOME%\plugins\*;" com.orientechnologies.teleporter.main.OTeleporter %CMD_LINE_ARGS%
