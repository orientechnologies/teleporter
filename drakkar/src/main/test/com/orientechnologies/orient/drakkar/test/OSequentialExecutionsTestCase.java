...
public class OSequentialExecutionsTestCase {
  ...
  private ONaiveImportStrategy naiveImportStrategy;
  private ONaiveAggregationImportStrategy naiveAggregationImportStrategy;
  ...
  public void schemaModificationTest1() {
    ...
    try {
      ...
      this.naiveImportStrategy.executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "java", context);
  ...
  public void contentModificationTest2() {
    ...
    try {
      ...
      this.naiveAggregationImportStrategy.executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "java", context);
