...
import com.orientechnologies.orient.drakkar.mapper.OJPA2GraphMapper;
...
public class OMapperFactory {
  ...
  public OSource2GraphMapper buildMapper(String chosenMapper, String driver, String uri, String username, String password, String xmlPath, ODrakkarContext context) {
