...
public class ImportWithInputConfigurationTest {
    ...
    try {
      ...
      this.naiveStrategy
          .executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "basicDBMapper",
              null, "java", null, null, this.configDirectEdgesPath, context);
  ...
  public void test2() {
    ...
    try {
      ...
      this.naiveStrategy
          .executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "basicDBMapper",
              null, "java", null, null, this.configInverseEdgesPath, context);
  ...
  public void test3() {
    ...
    try {
      ...
      this.naiveAggregationStrategy
          .executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "basicDBMapper",
              null, "java", null, null, this.configJoinTableDirectEdgesPath, context);
  ...
  public void test4() {
    ...
    try {
      ...
      this.naiveAggregationStrategy
          .executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "basicDBMapper",
              null, "java", null, null, this.configJoinTableInverseEdgesPath, context);
  ...
  public void test6() {
    ...
    try {
      ...
      this.naiveAggregationStrategy
          .executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "basicDBMapper",
              null, "java", null, null, this.configJoinTableInverseEdgesPath2, context);
