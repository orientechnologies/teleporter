...
package com.orientechnologies.orient.teleport.writer;
...
public class OGraphModelWriter {
  ...
  public boolean writeModelOnOrient(OGraphModel graphModel, ODriverDataTypeHandler handler, String outOrientGraphUri, OTeleportContext context) {
   ...
   * @return
   */
  private boolean checkAndUpdateClass(OrientGraphNoTx orientGraph, OElementType currentElementType, ODriverDataTypeHandler handler, OTeleportContext context) {
