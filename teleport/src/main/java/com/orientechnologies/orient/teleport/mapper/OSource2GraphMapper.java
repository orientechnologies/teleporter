...
public abstract class OSource2GraphMapper {
  ...
  public abstract void buildSourceSchema(OTeleportContext context);

  public abstract void buildGraphModel(ONameResolver nameResolver, OTeleportContext context);
