...
package com.orientechnologies.orient.teleport.ui;
...
public class OProgressMonitor implements OStatisticsListener {
   ...
   */
  public OProgressMonitor(OTeleportContext context) {
  ...
  public void updateOnEvent(OTeleportStatistics statistics) {
   ...
   * @param statistics 
   */
  public void updateWork1OnEvent(OTeleportStatistics statistics) {
  ...
  public void updateWork2OnEvent(OTeleportStatistics statistics) {
  ...
  public void updateWork3OnEvent(OTeleportStatistics statistics) {
    /*
  ...
  public void updateWork4OnEvent(OTeleportStatistics statistics) {
