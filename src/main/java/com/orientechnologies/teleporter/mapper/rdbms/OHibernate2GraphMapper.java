...
public class OHibernate2GraphMapper extends OER2GraphMapper {
  ...
  public OHibernate2GraphMapper(String driver, String uri, String username, String password, String xmlPath,
      List<String> includedTables, List<String> excludedTables, ODocument configuration) {
  ...
  private void detectInheritanceAndUpdateSchema(OEntity parentEntity, Element parentEntityElement, OTeleporterContext context) {
    ...
    if (subclassElements.getLength() > 0) {
      ...
      this.performSubclassTagInheritance(hierarchicalBag, parentEntity, subclassElements, discriminatorElement,
          rootDiscriminatorValue, context);
    }
  ...
  private void performSubclassTagInheritance(OHierarchicalBag hierarchicalBag, OEntity parentEntity, NodeList subclassElements,
      Element discriminatorElement, String rootDiscriminatorValue, OTeleporterContext context) {
  ...
  private void performJoinedSubclassTagInheritance(OHierarchicalBag hierarchicalBag, OEntity parentEntity,
      NodeList joinedSubclassElements, OTeleporterContext context) {
