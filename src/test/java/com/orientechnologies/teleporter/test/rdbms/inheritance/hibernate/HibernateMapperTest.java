...
public class HibernateMapperTest {
  ...
  public void test1() {
    ...
    try {
      ...
      this.mapper = new OHibernate2GraphMapper("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "",
          HibernateMapperTest.XML_TABLE_PER_CLASS, null, null, null);
  ...
  public void test2() {
    ...
    try {
      ...
      this.mapper = new OHibernate2GraphMapper("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "",
          HibernateMapperTest.XML_TABLE_PER_SUBCLASS1, null, null, null);
      mapper.buildSourceDatabaseSchema(this.context);
      mapper.buildGraphModel(new OJavaConventionNameResolver(), context);
  ...
  public void test3() {
    ...
    try {
      ...
      this.mapper = new OHibernate2GraphMapper("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "",
          HibernateMapperTest.XML_TABLE_PER_SUBCLASS2, null, null, null);
      mapper.buildSourceDatabaseSchema(this.context);
      mapper.buildGraphModel(new OJavaConventionNameResolver(), context);
  ...
  public void test4() {
    ...
    try {
      ...
      this.mapper = new OHibernate2GraphMapper("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "",
          HibernateMapperTest.XML_TABLE_PER_CONCRETE_CLASS, null, null, null);
      mapper.buildSourceDatabaseSchema(this.context);
      mapper.buildGraphModel(new OJavaConventionNameResolver(), context);
