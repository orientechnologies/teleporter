@echo off
rem
rem Copyright (c) 2015 Orient Technologies LTD - www.orientechnologies.com
rem
...
if exist "%ORIENTDB_HOME%\bin\oteleporter.bat" goto okHome
cd ..
...
call %JAVA% -server %SSL_OPTS% %ORIENTDB_SETTINGS% -Dfile.encoding=utf-8 -Dorientdb.build.number="@BUILD@" -cp "%ORIENTDB_HOME%\lib\*;%ORIENTDB_HOME%\plugins\*;" com.orientechnologies.teleporter.main.OTeleporter %CMD_LINE_ARGS%
