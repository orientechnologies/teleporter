...
package com.orientechnologies.orient.teleport.strategy;
...
import com.orientechnologies.orient.teleport.factory.ODataTypeHandlerFactory;
import com.orientechnologies.orient.teleport.factory.OMapperFactory;
import com.orientechnologies.orient.teleport.factory.ONameResolverFactory;
import com.orientechnologies.orient.teleport.importengine.ODBQueryEngine;
import com.orientechnologies.orient.teleport.importengine.OGraphDBCommandEngine;
...
import com.orientechnologies.orient.teleport.model.graphmodel.OEdgeType;
import com.orientechnologies.orient.teleport.model.graphmodel.OGraphModel;
...
public class ONaiveImportStrategy implements OImportStrategy {
  ...
  public void executeStrategy(String driver, String uri, String username, String password, String outOrientGraphUri, String chosenMapper, String xmlPath, String nameResolverConvention, OTeleportContext context) {	
  ...
  public OSource2GraphMapper createSchemaMapper(String driver, String uri, String username, String password, String outOrientGraphUri, String chosenMapper, String xmlPath, ONameResolver nameResolver, OTeleportContext context) {
  ...
  public void executeImport(String driver, String uri, String username, String password, String outOrientGraphUri, OSource2GraphMapper genericMapper,  OTeleportContext context) {
   ...
   * @param context
   */
  protected void tablePerTypeImport(OHierarchicalBag bag, OER2GraphMapper mapper, ODBQueryEngine dbQueryEngine, OGraphDBCommandEngine graphDBCommandEngine, OTeleportContext context) {
      ...
      for(int i=bag.getDepth2entities().size()-1; i>=0; i--) {
        for(OEntity currentEntity: bag.getDepth2entities().get(i)) {
          ...
          while(records.next()) {
            ...
            if(!graphDBCommandEngine.justFullImportedInOrient(fullRecord, currentOutVertexType, propertiesOfIndex, context)) {
...
//            System.out.println();
   ...
   * @param context
   */
  protected void tablePerConcreteTypeImport(OHierarchicalBag bag, OER2GraphMapper mapper, ODBQueryEngine dbQueryEngine, OGraphDBCommandEngine graphDBCommandEngine, OTeleportContext context) {
    try {
      ...
      for(int i=bag.getDepth2entities().size()-1; i>=0; i--) {
        for(OEntity currentEntity: bag.getDepth2entities().get(i)) {
          ...
          while(records.next()) {
            ...
            if(!graphDBCommandEngine.justFullImportedInOrient(currentRecord, currentOutVertexType, propertiesOfIndex, context)) {
   ...
   * @return
   */
  private String searchParentEntityType(OEntity currentParentEntity, String[] propertyOfKey, String[] valueOfKey, String physicalArrivalEntityName, ODBQueryEngine dbQueryEngine, OTeleportContext context) {
   ...
   * @return
   */
  private String searchParentEntityTypeFromSingleTable(OEntity currentParentEntity, String[] propertyOfKey, String[] valueOfKey, String physicalEntityName, ODBQueryEngine dbQueryEngine, OTeleportContext context) {
   ...
   * @return
   */
  private String searchParentEntityTypeFromSubclassTable(OEntity currentParentEntity, String[] propertyOfKey, String[] valueOfKey, ODBQueryEngine dbQueryEngine, OTeleportContext context) {
   ...
   * @return
   */
  private String searchParentEntityTypeFromConcreteTable(OEntity currentParentEntity, String[] propertyOfKey, String[] valueOfKey, ODBQueryEngine dbQueryEngine, OTeleportContext context) {
   ...
   * @return
   */
  private ResultSet getFullRecordByAggregateTable(ResultSet aggregateTableRecords, String[] aggregateTablePropertyOfKey, String[] valueOfKey, OTeleportContext context) {
