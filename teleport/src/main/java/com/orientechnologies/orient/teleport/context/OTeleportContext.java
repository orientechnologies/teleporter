...
public class OTeleportContext {
  
  private OTeleportStatistics statistics;
  ...
  public OTeleportContext() {
    this.statistics = new OTeleportStatistics();
  }

  public OTeleportStatistics getStatistics() {
    return this.statistics;
  }

  public void setStatistics(OTeleportStatistics statistics) {
