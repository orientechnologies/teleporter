...
public class HibernateImportTest {
    ...
    try {
      ...
      this.importStrategy
          .executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "hibernate",
              HibernateImportTest.XML_TABLE_PER_CLASS, "java", null, null, null, context);
   ...
   */ public void test2() {
    ...
    try {
      ...
      this.importStrategy
          .executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "hibernate",
              HibernateImportTest.XML_TABLE_PER_SUBCLASS1, "java", null, null, null, context);
   ...
   */ public void test3() {
    ...
    try {
      ...
      this.importStrategy
          .executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "hibernate",
              HibernateImportTest.XML_TABLE_PER_SUBCLASS2, "java", null, null, null, context);
   ...
   */ public void test4() {
    ...
    try {
      ...
      this.importStrategy
          .executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "hibernate",
              HibernateImportTest.XML_TABLE_PER_CONCRETE_CLASS, "java", null, null, null, context);
