#!/bin/sh
#
# Copyright (c) 2015 Orient Technologies LTD - www.orientechnologies.com
#
...
[ -f "$ORIENTDB_HOME"/plugins/orientdb-teleporter-@VERSION@.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
$JAVA -server $JAVA_OPTS $ORIENTDB_SETTINGS $SSL_OPTS -Dfile.encoding=utf-8 -Dorientdb.build.number="@BUILD@" -cp "$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" com.orientechnologies.teleporter.main.OTeleporter $*
