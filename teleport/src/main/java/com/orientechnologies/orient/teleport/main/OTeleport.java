...
package com.orientechnologies.orient.teleport.main;
...
import com.orientechnologies.orient.teleport.factory.OStrategyFactory;
import com.orientechnologies.orient.teleport.strategy.OImportStrategy;
import com.orientechnologies.orient.teleport.ui.OProgressMonitor;
...
public class OTeleport {
  ...
  public static void main(String[] args) {
    ...
    OTeleport.execute(driver, jurl, username, password, outDbUrl, chosenStrategy, chosenMapper, xmlPath, nameResolver, outputLevel);
  }
  ...
  public static void execute(String driver, String jurl, String username, String password, String outDbUrl, String chosenStrategy, String chosenMapper, String xmlPath, String nameResolver, String outputLevel) {
    ...
    final OTeleportContext context = new OTeleportContext();
