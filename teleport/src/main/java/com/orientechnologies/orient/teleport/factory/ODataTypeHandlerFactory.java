...
import com.orientechnologies.orient.teleport.persistence.handler.OGenericDataTypeHandler;
import com.orientechnologies.orient.teleport.persistence.handler.OHSQLDBDataTypeHandler;
import com.orientechnologies.orient.teleport.persistence.handler.OMySQLDataTypeHandler;
import com.orientechnologies.orient.teleport.persistence.handler.OOracleDataTypeHandler;
import com.orientechnologies.orient.teleport.persistence.handler.OPostgreSQLDataTypeHandler;
...
public class ODataTypeHandlerFactory {
  ...
  public ODriverDataTypeHandler buildDataTypeHandler(String driver, OTeleportContext context) {
