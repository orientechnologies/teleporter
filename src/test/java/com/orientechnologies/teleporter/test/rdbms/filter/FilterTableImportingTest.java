...
public class FilterTableImportingTest {
   ...
   */ public void test1() {
    ...
    try {
      ...
      this.importStrategy
          .executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "basicDBMapper",
              null, "java", includedTables, null, null, context);
   ...
   */ public void test2() {
    ...
    try {
      ...
      this.importStrategy
          .executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "basicDBMapper",
              null, "java", null, excludedTables, null, context);
   ...
   */ public void test3() {
    ...
    try {
      ...
      this.importStrategy
          .executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "hibernate",
              FilterTableImportingTest.XML_TABLE_PER_CLASS, "java", includedTables, null, null, context);
   ...
   */ public void test4() {
    ...
    try {
      ...
      this.importStrategy
          .executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "hibernate",
              FilterTableImportingTest.XML_TABLE_PER_SUBCLASS1, "java", includedTables, null, null, context);
   ...
   */ public void test5() {
    ...
    try {
      ...
      this.importStrategy
          .executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "hibernate",
              FilterTableImportingTest.XML_TABLE_PER_SUBCLASS2, "java", null, excludedTables, null, context);
   ...
   */ public void test6() {
    ...
    try {
      ...
      this.importStrategy
          .executeStrategy("org.hsqldb.jdbc.JDBCDriver", "jdbc:hsqldb:mem:mydb", "SA", "", this.outOrientGraphUri, "hibernate",
              FilterTableImportingTest.XML_TABLE_PER_CONCRETE_CLASS, "java", includedTables, null, null, context);
